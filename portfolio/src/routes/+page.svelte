...
<section class="mb-5">
    <h2 class="h4 mb-3">My Businesses</h2>
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card text-light h-100">
                <div class="card-body">
                    <h5 class="card-title">Reg X Timing</h5>
                    ...
                    <a href="https://regxtiming.com" target="_blank"
                        class="btn btn-outline-light btn-sm stretched-link">View Site</a>
                </div>
            </div>
        </div>
...
<section class="mb-5">
    <h2 class="h4 mb-3">My Websites</h2>
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card text-light h-100">
                <div class="card-body">
...
<section class="mb-5">
    <h2 class="h4 mb-3">My Packages</h2>
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card text-light h-100">
                <div class="card-body">
...
<section class="mb-5">
    <h2 class="h4 mb-3">My Projects</h2>
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card text-light h-100">
                <div class="card-body">
